...
def all_odd(number_list):
    ...
    number_list = [odd_nums for odd_nums in number_list if odd_nums % 2 == 1]
    return number_list
...
def all_even(number_list):
    ...
    number_list = [even_nums for even_nums in number_list if even_nums % 2 == 0]
    return number_list
...
def every_other_item(my_list):
    ...
    return my_list[0:-1:2]
    #TEST PASSED, DO NOT EDIT CODE
